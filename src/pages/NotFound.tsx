  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-md">
        <div className="w-16 h-16 rounded-sharp bg-wash flex items-center justify-center mx-auto mb-6">
          <ExclamationTriangleIcon className="w-8 h-8 text-brick" />
        </div>
        <p className="text-5xl font-bold text-ink">404</p>
        <h1 className="text-xl font-semibold text-ink mt-3">Page not found</h1>
        <p className="text-mute mt-2">
          We couldn't find{' '}
          <span className="text-body font-mono break-all">{location.pathname}</span>.
